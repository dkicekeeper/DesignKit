...
public struct PackedCircle: Identifiable {
...
public enum CirclePackingLayout {

    /// Min/max circle diameters.
    public static let minDiameter: CGFloat = 28
    public static let maxDiameter: CGFloat = 56

    // MARK: - Public

    /// Compute diameters from amounts using linear interpolation.
    /// Returns diameters in the same order as input.
    public static func diameters(for amounts: [Double]) -> [CGFloat] {
