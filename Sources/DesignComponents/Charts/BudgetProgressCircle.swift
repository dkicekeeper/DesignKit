...
public struct BudgetProgressCircle: View {
    ...
    public init(progress: Double, size: CGFloat = AppIconSize.categoryIcon, lineWidth: CGFloat = 3, isOverBudget: Bool = false, overrideColor: Color? = nil, accessibilityLabel: String? = nil) {
