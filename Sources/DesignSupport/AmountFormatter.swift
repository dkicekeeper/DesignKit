...
nonisolated struct AmountFormatter {
    ...
    public static func isValidInput(_ text: String) -> Bool {
    ...
    public static func formatForInput(_ text: String, caretPosition: inout Int) -> String {
    ...
    public static func formatForInput(_ text: String) -> String {
        let cleaned = text
            .replacingOccurrences(of: " ", with: "")
            .replacingOccurrences(of: ",", with: ".")
    ...
    public static func validateDecimalPlaces(_ text: String) -> Bool {
        let cleaned = text.replacingOccurrences(of: " ", with: "")
    ...
    public static func validate(_ amount: Decimal) -> Bool {
